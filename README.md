...
Tokens provide means of authentication
...
Web servers are connected to the internet, and hosts pages and app. These app are served to an online client, when the client sends it a request for data.
